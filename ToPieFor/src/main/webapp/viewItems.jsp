                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td><a href="ItemController?act=toadd" class="btn btn-sm btn-primary">Add</a></td>
                                                    <th scope="col"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                %><tr>
                                                    ...
                                                    <td><%=i.getNutritionalValue()%></td>
                                                    <td><%=i.getWarnings()%></td>
                                                    <td><%= active%></td>
                                                    <td><img src="images/<%=i.getImageUrl()%>" height="75px" width="75px" align="left" /></td>
                                                    <td>
                                                        <a href='ItemController?act=itembyid&itemId=<%=i.getItemId()%>' class='btn btn-sm btn-primary' >Edit</a></td>         
                                                    <td>
                                                        <a href='ItemController?act=activate&itemId=<%=i.getItemId()%>&isActive=<%=true%>' class='btn btn-sm btn-primary' >Activate</a></td>
                                                    <td>
                                                        <a href='ItemController?act=activate&itemId=<%=i.getItemId()%>&isActive=<%=false%>' class='btn btn-sm btn-primary' >Deactivate</a></td>
